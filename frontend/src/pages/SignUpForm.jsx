  ...
  return (
    <div className="signupForm">
      <div className="signupForm__left">
        ...
        <div className="signupForm__icon" aria-hidden="true">
        ...
        <form className="signupForm__form" onSubmit={handleSubmit}>
          ...
          <label className="signupForm__checkRow">
            <input type="checkbox" />
            <span>
              I agree to the <a href="#" onClick={(e) => e.preventDefault()}>terms &amp; policy</a>
            </span>
          </label>

          <button className="signupForm__primary" type="submit">
            Sign up
          </button>
      ...
      <div className="signupForm__right">
        <img className="signupForm__img" src={heroImg} alt="Food preparation" />
      </div>
    </div>
  );
}
