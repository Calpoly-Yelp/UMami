...
function Header() {
   ...
   const handleNotificationClick = async (notification) => {
      ...
      try {
         await fetch(
            `https://umami-api-calpoly-bpqzacb7ckf3hked.westus3-01.azurewebsites.net/api/notifications/${notification.id}/read`,
            { method: "PATCH" },
         );
      } catch (error) {
         console.error(
   ...
   const handleMarkAllRead = async () => {
      ...
      try {
         await fetch(
            `https://umami-api-calpoly-bpqzacb7ckf3hked.westus3-01.azurewebsites.net/api/notifications/${userId}/read-all`,
            {
               method: "PATCH",
            },
         );
   ...
   const handleDeleteAllNotifications = async () => {
      ...
      try {
         await fetch(
            `https://umami-api-calpoly-bpqzacb7ckf3hked.westus3-01.azurewebsites.net/api/notifications/${userId}/delete-all`,
            { method: "DELETE" },
         );
      } catch (error) {
         console.error(
   ...
   const handleDeleteNotification = async (
      ...
      try {
         await fetch(
            `https://umami-api-calpoly-bpqzacb7ckf3hked.westus3-01.azurewebsites.net/api/notifications/${notificationId}`,
            {
               method: "DELETE",
            },
         );
      ...
      const loadUserAndNotifications = async () => {
         ...
         try {
            const response = await fetch(
               `https://umami-api-calpoly-bpqzacb7ckf3hked.westus3-01.azurewebsites.net/api/notifications/${userId}`,
            );
            if (response.ok) {
   ...
   useEffect(() => {
      const fetchUsers = async () => {
         try {
            const response = await fetch(
               "https://umami-api-calpoly-bpqzacb7ckf3hked.westus3-01.azurewebsites.net/api/users",
            );
            if (response.ok) {
               const data = await response.json();
               setAllUsers(data);
   ...
   useEffect(() => {
      if (user && user.id) {
         const fetchFollows = async () => {
            try {
               const response = await fetch(
                  `https://umami-api-calpoly-bpqzacb7ckf3hked.westus3-01.azurewebsites.net/api/users/${user.id}/follows`,
               );
               if (response.ok) {
                  const data = await response.json();
                  setFollowedSet(
